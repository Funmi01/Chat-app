  ...
  return (
    <div id="app-wrapper">
      <div className="icon-bar">
        <a href="#active">
          <i id="active" className="fa fa-home">
        ...
        <a href="#active">
          <i id="active" className="fas fa-comment-alt">
        ...
        <a href="#active">
          <img
            ...
            src={require("../../img/profiles/you.jpg")}
            alt="youpic"
          />
        </a>
      </div>
      <div id="chat-container">
        ...
        <div id="conversation-list">
          <div className="conversation active">
            <img
              className="profile"
              src={require("../../img/profiles/kelly.jpg")}
              alt="Kelly Johnson"
            />
          ...
          <div className="conversation">
            <img
              className="profile"
              src={require("../../img/profiles/vanessa.jpg")}
              alt="Vanessa Chude"
            />
          ...
          <div className="conversation">
            <img
              className="profile"
              src={require("../../img/profiles/kourtney.jpg")}
              alt="kourtney Tim"
            />
          ...
          <div className="conversation">
            <img
              className="profile"
              src={require("../../img/profiles/jake.jpg")}
              alt="Janke Yu"
            />
          ...
          <div className="conversation">
            <img
              className="profile"
              src={require("../../img/profiles/tunde.jpg")}
              alt="Tunde Folaranmi"
            />
          ...
          <div className="conversation">
            <img
              className="profile"
              src={require("../../img/profiles/toyosi.jpg")}
              alt="Toyosi Vicker"
            />
          ...
          <div className="conversation">
            <img
              className="profile"
              src={require("../../img/profiles/amie.jpg")}
              alt="Amie Peralta"
            />
          ...
          <div className="conversation">
            <img
              className="profile"
              src={require("../../img/profiles/vik.jpg")}
              alt="Vik Andres"
            />
